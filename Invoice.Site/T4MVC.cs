...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class ThirdParty {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string jquery_matchHeight_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.matchHeight.min.js") ? Url("jquery.matchHeight.min.js") : Url("jquery.matchHeight.js");
        }
    ...
    public static class Content {
        ...
        public static readonly string Seesmic_Logo_png = Url("Seesmic_Logo.png");
        public static readonly string Site_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Site.min.css") ? Url("Site.min.css") : Url("Site.css");
        public static readonly string steam_jpg = Url("steam.jpg");
    }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            ...
            public static partial class ThirdParty 
            {
                public static class Assets
                {
                    public const string jquery_matchHeight_js = "~/Scripts/ThirdParty/jquery.matchHeight.js"; 
                }
            }
            public static class Assets
            {
